...
The assumption is you want an insurance policy against catastrophic loss. You might never make full restorations due to the cost. Your primary backups are elsewhere, such as on local hard drives. A restoration would be a once in a lifetime event, for the entire thing, although it's designed to be modular so restoring smaller pieces is very affordable.
